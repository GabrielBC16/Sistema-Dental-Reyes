...
public class IU_AutenticarUsuario extends javax.swing.JFrame {
    ...
    private void initComponentsModerno() {
        ...
        cardPanel.setBounds(450, 50, 350, 400);
        ...
        lblBrand.setForeground(new Color(255, 255, 255, 200));
    ...
    private void logicaLogin() {
        ...
        // El controlador valida Y GUARDA la sesión automáticamente si es correcto
